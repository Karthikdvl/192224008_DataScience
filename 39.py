...
data = pd.read_csv("C:/Users/user/OneDrive/Desktop/Fods/tansaction_data.csv")

# Select features for clustering
features = ['total_amount_spent', 'number _of_items']
...
sns.scatterplot(data=data, x='total_amount_spent',
                y='number _of_items', hue='cluster', palette='Set1')
